...
public class WhiteBoxTester {
    ...
    private static void runWBT01() {
        ...
        if (result == 1.0) {
            System.out.println("PASS ✔️ (Result exactly 1.0)");
        } else {
    ...
    private static void runWBT02() {
        ...
        if (result == 1.0) {
            System.out.println("PASS ✔️ (Score capped safely at 1.0)");
        } else {
            System.out.println("FAIL ❌ (Got: " + result + ")");
        }
    }
    ...
    private static void runWBT03() {
        ...
        if (testTask.assignedTo.equals("Alice")) {
            System.out.println("PASS ✔️ (Engine aborted correctly, loop prevented)");
        } else {
    ...
    private static void runWBT04() {
        ...
        if (nextState.equals("DRAFT")) {
            System.out.println("PASS ✔️ (Invalid action blocked, remained in DRAFT)");
        } else {
